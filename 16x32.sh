...
cd ~/Downloads
wget http://downloads.pf.itd.nrl.navy.mil/core/packages/4.8/core-daemon_4.8-0ubuntu1_precise_i386.deb --no-check-certificate
...
# install core
cd ~/Downloads
sudo dpkg -i core-daemon_4.8-0ubuntu1_precise_i386.deb
